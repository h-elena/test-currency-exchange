...
**Запуск скрипта из консоли командой `php v1/currency/exchange/index.php`.**
В ТЗ не было условия о написании тестов. Но в композере предусмотрена их установка..gitignore